...
interface SubtitleService {
     ...
     * @return [NetworkResponse] including [ApiResponse] that consists of [Subtitle]
     */
    @GET("discover/most_downloaded")
    suspend fun getMostDownloaded(@Query("languages") languages: String? = null, @Query("type") type: String? = null): NetworkResponse<ApiResponse<Subtitle>, NetworkError>
     ...
     */
    @GET("discover/latest")
    suspend fun getLatestSubtitles(@Query("languages") languages: String? = null, @Query("type") type: String? = null): NetworkResponse<ApiResponse<Subtitle>, NetworkError>
}